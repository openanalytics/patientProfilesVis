...
* Create subject profile report for specific trial:
    + main endpoint
    + laboratory data
    + adverse events
    + ...
...
* Non-statisticians/medics: user-friendly graphical interface for creation
  of patient profile report
* Statisticians/programmers: functionalities available via `R` package 
...
* to display evolution of numeric metric of parameters of interest in the
  time frame:  
