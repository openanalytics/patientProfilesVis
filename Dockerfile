...
RUN R -q -e "remotes::install_version('crayon', version = '1.5.2', upgrade = FALSE)" && \
    R -q -e "remotes::install_version('curl', version = '5.2.0', upgrade = FALSE)" && \
    R -q -e "remotes::install_version('data.table', version = '1.14.10', upgrade = FALSE)" && \
...
RUN R -q -e "remotes::install_version('prettyunits', version = '1.2.0', upgrade = FALSE)" && \
...
RUN R -q -e "remotes::install_version('sys', version = '3.4.2', upgrade = FALSE)" && \
    ...
    R -q -e "remotes::install_version('xfun', version = '0.41', upgrade = FALSE)" && \
...
RUN R -q -e "remotes::install_version('plyr', version = '1.8.9', upgrade = FALSE)" && \
...
RUN R -q -e "remotes::install_version('memoise', version = '2.0.1', upgrade = FALSE)" && \
    ...
    R -q -e "remotes::install_version('qpdf', version = '1.3.2', upgrade = FALSE)" && \
...
RUN R -q -e "remotes::install_version('hms', version = '1.1.3', upgrade = FALSE)" && \
    ...
    R -q -e "remotes::install_version('pdftools', version = '3.4.0', upgrade = FALSE)" && \
...
RUN R -q -e "remotes::install_version('rmarkdown', version = '2.25', upgrade = FALSE)" && \
...
RUN R -q -e "remotes::install_version('testthat', version = '3.2.1', upgrade = FALSE)" && \
