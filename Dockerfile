...
RUN R -q -e "remotes::install_version('isoband', version = '0.2.7', upgrade = FALSE)" && \
    ...
    R -q -e "remotes::install_version('MASS', version = '7.3-60.0.1', upgrade = FALSE)" && \
...
RUN R -q -e "remotes::install_version('desc', version = '1.4.3', upgrade = FALSE)" && \
...
RUN R -q -e "remotes::install_version('rmarkdown', version = '2.26', upgrade = FALSE)" && \
