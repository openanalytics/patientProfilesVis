...
# Specification of the color/shape
...
```{r createSubjectProfileReport-SDTM, out.width = "100%"}
...
Here is the resulting [subject profile report](`r pathReport`).
