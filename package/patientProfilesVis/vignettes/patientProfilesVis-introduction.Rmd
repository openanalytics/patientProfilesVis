...
If only a subset of parameters are of interest `subsetVar` and `subsetValue` can be used. By default, the subset is extracted from the current `data`, but can also be extracted from a different dataset specified via `subsetData`. These parameters are here used to represent only the measurements for the hematology parameters.
...
The `subsetData` parameter is used to specify only a subset of the subjects available in a different dataset. For example, to create the laboratory plots only for the patients with serious adverse events:

```{r exampleEventModuleWithSubset-3}

	# consider only serious Adverse Events
	dataAESER <- subset(dataSDTM$AE, AESER == "Y")
...
```{r createSubjectProfileReport-SDTM}
...
Here is the resulting subject profile report:

```{r createSubjectProfileReport-SDTM-include, echo = FALSE, out.width = "100%", out.height = "500px"}
knitr::include_graphics(pathReport)
```

### ADaM dataset

```{r createSubjectProfileReport-ADaM}
...
```{r createSubjectProfileReport-ADaM-include, echo = FALSE, out.width = "100%", out.height = "500px"}
knitr::include_graphics(pathReport)
```
...
```{r createSubjectProfileReport-referenceLines-custom}
...
```{r createSubjectProfileReport-referenceLines-custom-include, echo = FALSE, out.width = "100%", out.height = "500px"}
knitr::include_graphics(pathReport)
```
...
```{r createSubjectProfileReport-referenceLines-subjectVisit}
...
```{r createSubjectProfileReport-referenceLines-subjectVisit-include, echo = FALSE, out.width = "100%", out.height = "500px"}
knitr::include_graphics(pathReport)
```
...
```{r createSubjectProfileReport-bookmarks}
...
```{r createSubjectProfileReport-bookmarks-include, echo = FALSE, out.width = "100%", out.height = "500px"}
knitr::include_graphics(pathReport)
```
...
```{r createReportWithAllModules-default-include, echo = FALSE, out.width = "100%", out.height = "500px"}
knitr::include_graphics(pathReport)
```
...
```{r createReportWithAllModules-timeAlign-AE-include, echo = FALSE, out.width = "100%", out.height = "500px"}
knitr::include_graphics(pathReport)
```
...
```{r createReportWithAllModules-timeAlign-none-include, echo = FALSE, out.width = "100%", out.height = "500px"}
knitr::include_graphics(pathReport)
```
...
```{r createReportWithAllModules-timeAlignPerSubject-all-include, echo = FALSE, out.width = "100%", out.height = "500px"}
knitr::include_graphics(pathReport)
```
