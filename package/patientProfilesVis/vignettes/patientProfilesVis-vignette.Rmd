...
'zoom' in the study timeframe.
The `timeTrans` parameter is used to specify a custom transformation of the time-axis.

The `getTimeTrans` provides convenient transformations: 'asinh' and 'asinh' only for
negative relative time.
The latest is typically of interest for specific domain
including a long time frame before baseline, 
e.g. for concomitant medications which might be recorded long before the start of the study.
