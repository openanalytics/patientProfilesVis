...
Please have a look at the section 'Missing times' of the documentation of the
...
The second option is used below to extract the time limits based on all visist
...
```{r exampleIntervalModule-ae-timeLimData-include, echo = FALSE, fig.height = getNLinesYGgplot(aePlotsTimLimFromSV[[1]])*heightLineIn, fig.width = 14, fig.cap = paste0("Adverse events with the 'subjectProfileIntervalPlot' function for patient:", names(aePlotsTimLimFromSV)[1], ". Missing start/end date are extracted from the subject-level datasets.")}

	print(aePlotsTimLimFromSV[[1]])
...
```{r exampleIntervalModule-cm-restrictedTimeLimits-include, echo = FALSE, fig.height = getNLinesYGgplot(cmPlotsTimeSV[[1]])*heightLineIn, fig.width = 14, fig.cap = paste("Concomitant medications with the 'subjectProfileIntervalPlot' function for patient:", names(cmPlots)[1], "with time limits restricted to subject visits")}

	print(cmPlotsTimeSV[[1]])
...
```{r exampleIntervalModule-cm-restrictedTimeLimits2-include, echo = FALSE, fig.height = getNLinesYGgplot(cmPlotsTimeSpec[[1]])*heightLineIn, fig.width = 14, fig.cap = paste("Concomitant medications with the 'subjectProfileIntervalPlot' function for patient:", names(cmPlotsTimeSpec)[1], "with time limits restricted to: (", toString(timeLim), ")")}

	print(cmPlotsTimeSpec[[1]])
...
```{r exampleEventModuleWithColor-include, echo = FALSE, fig.height = getNLinesYGgplot(lbPlotsColor[[1]])*heightLineIn, fig.width = 14, fig.cap = paste("Laboratory data with reference range with the 'subjectProfileEventPlot' function for patient:", names(lbPlotsColor)[1])}
...
```{r exampleEventModuleWithSubset-include, echo = FALSE, fig.height = getNLinesYGgplot(lbPlotsSubset[[1]])*heightLineIn, fig.width = 14, fig.cap = paste("Hematology data with the 'subjectProfileEventPlot' function for patient:", names(lbPlotsSubset)[1])}

	print(lbPlotsSubset[[1]])
...
```{r exampleLineModule}
	...
	lbLinePlots <- subjectProfileLinePlot(
		...
		timeVar = "LBDY",
		title = "Hematology test measurements: actual value",
