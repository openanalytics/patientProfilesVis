...
```{r exampleTextModule-tableFormat-include, echo = FALSE, fig.height = attributes(aeListingPlots[[1]][[1]])$metaData$nLines*heightLineIn, fig.width = 14, fig.cap = paste("Adverse event listing with the 'subjectProfileTextPlot' function for patient:", names(aeListingPlots)[1])}
...
```{r exampleTextModule-tableFormat-customWidth}
	...
	aeListingPlots <- subjectProfileTextPlot(
		...
		labelVars = labelVarsSDTMPelican,
		table = TRUE,
		colWidth = c(0.1, 0.1, 0.1, 0.1, 0.4, 0.05, 0.05, 0.05, 0.05)
	)
	
```

```{r exampleTextModule-tableFormat-customWidth-include, echo = FALSE, fig.height = attributes(aeListingPlots[[1]][[1]])$metaData$nLines*heightLineIn, fig.width = 14, fig.cap = paste("Adverse event listing with the 'subjectProfileTextPlot' function for patient:", names(aeListingPlots)[1])}
