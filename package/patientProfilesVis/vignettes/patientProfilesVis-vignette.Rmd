...
### Axis range based on the observations or reference range

By default, the range of the y-axis spans the reference range or the
range of the observations is smaller.

If the range of the y-axis should only contain the data range, so shouldn't be extended
...
The specified time limits are used for the adverse events module.
