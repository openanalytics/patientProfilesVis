...
```{r exampleIntervalModule-cm-include, echo = FALSE, fig.height = attributes(cmPlots[[1]][[1]])$metaData$nLines*heightLineIn, fig.width = 14, fig.cap = paste("Concomitant medications with the 'subjectProfileIntervalPlot' function for patient:", names(cmPlots)[1])}
...
```{r exampleLineModule}
	...
	# create plot
	system.time(lbLinePlots <- subjectProfileLinePlot(
		data = dataLB,
		paramNameVar = "LBTEST", 
