...
```{r exampleTestModule1-include, echo = FALSE, height = getNLinesYGgplot(dmPlots[[1]])*0.14, width = 14}

	cat("Patient:", names(dmPlots)[1])
	print(dmPlots[[1]])
...
```{r exampleTestModule2-include, echo = FALSE, height = getNLinesYGgplot(mhPlots[[1]])*0.14, width = 14}
...
```{r exampleIntervalModule-include, echo = FALSE, height = getNLinesYGgplot(aePlots[[1]])*0.14, width = 14}
...
```{r exampleEventModule-include, echo = FALSE, height = getNLinesYGgplot(lbPlots[[1]])*0.14, width = 14}
...
```{r exampleEventModuleWithColor-include, echo = FALSE, height = getNLinesYGgplot(lbPlotsColor[[1]])*0.14, width = 14}
